...
### Phase 6: Exit
**IMPORTANT**: After completing all steps above, you MUST exit immediately:
```
/exit
```

Do NOT wait for further instructions. Exit as soon as the PR is created and phase is updated.
