...
// build/dev/javascript/example_01_simple/components/greeting.mjs
function render(name) {
  return div(toList([class$("greeting")]), toList([
    h1(toList([]), toList([text2("Hello, "), text2(name), text2("!")])),
    p(toList([]), toList([text2("Welcome to Lustre with template generation.")]))
  ]));
}

// build/dev/javascript/example_01_simple/example_01_simple.mjs
var FILEPATH = "src/example_01_simple.gleam";
...
function main() {
  ...
  if (!($ instanceof Ok)) {
    throw makeError("let_assert", FILEPATH, "example_01_simple", 9, "main", "Pattern match failed, no pattern matched the value.", { value: $, start: 190, end: 239, pattern_start: 201, pattern_end: 206 });
  }
  return;
}

// .lustre/build/example_01_simple.mjs
main();
